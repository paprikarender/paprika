...
RUN apt-get update && \
    apt-get install -y git gcc g++ libboost-all-dev libopenexr-dev make cmake flex bison zlib1g-dev llvm-dev libclang-dev clang libtiff5-dev libpng12-dev wget lua5.1 liblua5.1-0-dev && \
    cd ~ && \
